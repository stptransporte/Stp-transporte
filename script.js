...
const learnerSections = [
  ...
  document.querySelector("#evaluacion"),
];
...
document.querySelector("#loginForm").addEventListener("submit", (event) => {
  ...
  loginMessage.textContent = "Credenciales demo: user/user o admin/admin.";
...
function showUserView() {
  ...
  learnerSections.forEach((section) => section.classList.remove("hidden"));
  loginMessage.textContent = "Sesion iniciada como usuario conductor.";
...
function showAdminView() {
  ...
  learnerSections.forEach((section) => section.classList.add("hidden"));
  loginMessage.textContent = "Sesion iniciada como administrador.";
  loginMessage.classList.remove("error");
}
